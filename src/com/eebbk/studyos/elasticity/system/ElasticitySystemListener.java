 ...
 */
public interface ElasticitySystemListener {
   ...
   */
  void onBeforeIntegrate(BaseElasticitySystem overshotSystem);
   ...
   * @param springSystem the BaseSpringSystem listened to
   */
  void onAfterIntegrate(BaseElasticitySystem overshotSystem);
}
